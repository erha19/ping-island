...
final class OpenCodeIntegrationTests: XCTestCase {
    ...
    func testOpenCodeManagedPluginIncludesEventMappingAndReplyFlow() throws {
        ...
        XCTAssertTrue(source.contains("type === \"message.part.delta\""))
        ...
        XCTAssertTrue(source.contains("notification_type: \"assistant_message\""))
        XCTAssertTrue(source.contains("appendAssistantDelta"))
        XCTAssertTrue(source.contains("ASSISTANT_DELTA_FLUSH_MS"))
        XCTAssertTrue(source.contains("scheduleAssistantNotification"))
        XCTAssertTrue(source.contains("flushAssistantNotification"))
        XCTAssertTrue(source.contains("subprocess.kill(\"SIGTERM\")"))
