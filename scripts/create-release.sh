...
APP_PATH="$EXPORT_PATH/NotchCode.app"
APP_NAME="NotchCode"
...
- Download \`$(basename "$DMG_PATH")\` and install the latest NotchCode release.
...
- Open the DMG, drag NotchCode to Applications, and launch it normally.
- After installation, NotchCode will automatically check for updates."
        fi
    fi
