...
enum ClientProfileRegistry {
    ...
    nonisolated static let runtimeProfiles: [SessionClientProfile] = [
        ...
        SessionClientProfile(
            ...
            defaultOrigin: "desktop",
            recognizedKinds: ["chatgpt", "chatgpt-app", "chatgpt-desktop", "codex-app", "codex_app", "codex app", "app", "desktop"],
            exactAliases: ["chatgpt", "chatgpt app", "chatgpt desktop", "codex-app", "codex app", "codex desktop", "codex-desktop", "desktop"],
            keywordAliases: ["chatgpt app", "chatgpt desktop", "codex app", "codex desktop"],
