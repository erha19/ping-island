...
NotchCode's normal `PingIsland` target remains packaged for direct Developer
...
- App Store name: NotchCode
- Bundle display name: NotchCode (Chinese: 灵动码)
